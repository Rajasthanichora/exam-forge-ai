<div align="center">
  <img src="assets/exam-forge-transparant.png" alt="Axam" width="200"/>
  <h1 align="center">Axam</h1>
  <p align="center">
...
### Question Shuffle Screen
- **Shuffle Questions & Options** - Randomize question order and option positions before generating the test
- **Full Control** - Toggle shuffling for questions and/or options independently
- **Fair Testing** - Prevent answer memorization by varying question presentation
...
<table>
  <tr>
    <td align="center" width="33%">
      ...
      <sub>Quick access to tests, documents, and chat</sub>
    </td>
    <td align="center" width="33%">
...
axam/
  ...
  components/             Reusable UI components
    ...
    SectionHistory.tsx    Section-wise history
    SectionSidebar.tsx    Section navigation sidebar
    SimilarityIndicator.tsx Duplicate question detector
